package com.y4l3.platform.module.common;
...
import com.y4l3.platform.common.utils.SpringContextUtil;
...
public class CommonService {
	...
	public static boolean deleteBy(Class<?> clazz, Map<String, Object> map) {
		String table = ReflectUtils.getTable(clazz);
		List<com.y4l3.platform.module.common.Field> fields = CommonUtils.mapToField(map);
