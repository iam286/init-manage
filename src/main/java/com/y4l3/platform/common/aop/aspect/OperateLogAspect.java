...
import com.y4l3.platform.common.aop.annotation.CustomOperateLog;
...
import com.y4l3.platform.common.utils.CommonUtils;
import com.y4l3.platform.common.utils.HttpServletUtils;
import com.y4l3.platform.common.utils.ReflectUtils;
...
public class OperateLogAspect {
	 ...
	 * 切点-登录登出
	 */
	@Pointcut("@annotation(com.y4l3.platform.common.aop.annotation.CustomOperateLog)")
	 ...
	 * 切点-查询
	 */
	@Pointcut("execution(* com.y4l3.platform.module..*.service.*.find*(..))")
	 ...
	 * 切点-修改
	 */
	@Pointcut("execution(* com.y4l3.platform.common.base.BaseService.updateWithOperateLog(..))")
	 ...
	 * 切点-保存
	 */
	@Pointcut("execution(* com.y4l3.platform.common.base.BaseService.save(..))")
	 ...
	 * 切点-删除
	 */
	@Pointcut("execution(* com.y4l3.platform.common.base.BaseService.delete(..))")
