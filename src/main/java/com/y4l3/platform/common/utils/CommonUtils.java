...
public class CommonUtils {
	 ...
	 * @return 字段属性值数组
	 */
	public static List<com.y4l3.platform.module.common.Field> mapToField(Map<String, Object> map) {
		List<com.y4l3.platform.module.common.Field> fields = new ArrayList<com.y4l3.platform.module.common.Field>();
		for (Entry<String, Object> entry : map.entrySet()) {
			String fieldName = entry.getKey();
			Object fieldValue = entry.getValue();
			com.y4l3.platform.module.common.Field field = new com.y4l3.platform.module.common.Field();
